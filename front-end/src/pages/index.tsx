...
const Home: NextPage = () => {
  ...
  const [avatarPathCurrent, setAvatarPathCurrent] = React.useState<string>("profile_14");
  ...
  const [isConnectedWallet, setConnectedWallet] = React.useState<boolean>(false);
    ...
    <>
      ...
      <Flex flex={1} w="full" flexDirection={{ base: "column", lg: "row" }}>
        ...
        >
            ...
            <VStack alignItems="flex-start">
              ...
              >
                <Box
                  ...
                  border={available === "Bronxe" ? "2px solid #6938EF" : "1px solid  #D0D5DD"}
                  boxShadow={available === "Bronxe" ? "0px 4px 4px rgba(151, 71, 255, 0.35)" : ""}
                  _hover={available != "Bronxe" ? { border: "1px solid #444CE7" } : {}}
                ...
                <Box
                  ...
                  boxShadow={available === "Gold" ? "0px 4px 4px rgba(151, 71, 255, 0.35)" : ""}
                  border={available === "Gold" ? "2px solid #6938EF" : "1px solid  #D0D5DD"}
                  _hover={available != "Gold" ? { border: "1px solid #444CE7" } : {}}
                  p="10px 16px"
                  color="#1D2939"
                  fontSize="14px"
                  fontFamily={fonts.Inter}
          ...
          {available === "Bronxe" &&
            <Box>
              <div style={{ overflow: "auto", height: "300px", width: "100%", padding: "20px" }}>
                  ...
                  {LIST_AVATAR.map((avatar) => (
                    ...
                    >
                      <Image
                        ...
                        borderRadius="12px"
                        //
                        src={`profile/${avatar}.svg`} onClick={() => {
              ...
              <Flex alignItems="center" marginTop="20px">
                ...
                <Button
                  ...
                  onClick={() => { setMessageButton("Cancle"); setAvatarPath(avatarPathCurrent); setAvailable(""); }}
                ...
                <Button
                  ...
                  w="fit-content"
                  cursor="pointer"
                  onClick={() => { setMessageButton("OK"); setAvatarPathCurrent(avatarPath); setAvailable("") }}
                >
                  <Text
                    color="#344054"
                    fontSize="14px"
            ...
            >
              <Flex w="full" flex={1} marginRight={{base: 0, lg: 2}}>
                ...
                {isConnectedSteam ? (
                  ...
                  <Box width="full" display="flex" justifyContent="center" flexDirection="column" alignItems="center"  >
                    <Box textAlign="center" position="relative" w="full" justifyContent="center" alignItems="center" display="flex" >
                    ...
                    <Button
                      borderRadius="8px"
                      bg="#194185" color="white"
                      _hover={{ bg: "#2d69cf" }}
                      onClick={() => { window.open("steam://", "_blank"); setConnectedSteam(true) }}
                    >
            ...
            <Table w="full" className="game-table-no-border-header">
              ...
              {new Array(3).fill(0).map((item, index) => (
                <Tr key={index.toString()}>
                    <Td>
                      <HStack>
                        <Image borderRadius="6px" src={`/dashboard/card_0${index+1}.png`} mr="12px" />
                        <Text variant="with-sub" fontWeight="500" color="#101828">
           ...
           <Table w="full" className="game-table-no-border-header">
             ...
             {new Array(3).fill(0).map((item, index) => (
               <Tr key={index.toString()}>
                   <Td>
                     <HStack>
                       <Image borderRadius="6px" src={`/dashboard/nft_0${index+1}.png`} mr="12px" />
                       <Text variant="with-sub" fontWeight="500" color="#101828">
                       Steam Card Level {index+1} 
                       </Text>
                     </HStack>
     ...
     >
       ...
       >
         View All
            ...
            <Box paddingBottom="50px" paddingTop="50px" w="full" display="flex" justifyContent="center" flexDirection="column" alignItems="center"
              bg="#F9FAFB"
            >
              <Image src="/empty.svg" h="112px"></Image>
              <Text color="#475467"
